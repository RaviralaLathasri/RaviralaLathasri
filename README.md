# ⚡ Lathasri Ravirala | Data & AI Engineer
...
### 1. RAG Chatbot with Meta LLaMA
Built a strict document QA assistant with PDF/TXT ingestion, semantic retrieval, and low-hallucination response generation.

### 2. Air Quality & Environmental Insights
Designed an interactive Power BI dashboard that analyzes pollution data, identifies hotspots, and surfaces actionable insights.

### 3. India Road Accident Analytics
Delivered a multi-page Power BI report with drill-through actions, state-level risk analysis, and driver safety insights.

### 4. Quantum-Enhanced Investment Recommendation
Built a hybrid fintech prototype combining QAOA optimization, Gemini AI analysis, and portfolio risk profiling.

### 5. Pneumonia & Tuberculosis Detection
Developed a CNN-based medical imaging classifier with image preprocessing and a desktop prediction GUI.
